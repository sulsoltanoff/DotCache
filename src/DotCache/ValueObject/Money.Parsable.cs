...
{
    /// <summary>Converts the string representation of a money value to its <see cref="ValueObject.Money"/> equivalent.</summary>
    ...
    /// <summary>Converts the string representation of a money value to its <see cref="ValueObject.Money"/> equivalent. A return value indicates whether the conversion succeeded or failed.</summary>
    /// <param name="value">The string representation of the money to convert.</param>
    /// <param name="result">When this method returns, contains the <see cref="ValueObject.Money"/> value that is equivalent to the money
    ...
    private static Currency ExtractCurrencyFromString(string value)
    {
        ...
        string currencyAsString = new(value.Where(IsNotNumericCharacter()).ToArray());
