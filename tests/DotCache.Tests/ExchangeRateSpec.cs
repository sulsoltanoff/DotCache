...
namespace DotCache.Tests
{
    public partial class GivenIWantToConvertMoney
    {
        private readonly Currency _euro = Currency.FromCode("EUR");

        private readonly Currency _dollar = Currency.FromCode("USD");

        private ExchangeRate _exchangeRate = new(Currency.FromCode("EUR").Code, Currency.FromCode("USD").Code, 1.2591m);
                             // EUR/USD 1.2591
    ...
    public class GivenIWantToCreateAnExchangeRateWithCurrencies
    {
        ...
        {
            var fx = new ExchangeRate(_euro.Code, _dollar.Code, 1.2591478D);
        ...
        {
            var fx = new ExchangeRate(_euro.Code, _dollar.Code, 1.2591478D, 3);
        ...
        {
            var fx = new ExchangeRate(_euro.Code, _dollar.Code, 1.2591M);
        ...
        {
            var fx = new ExchangeRate(_euro.Code, _dollar.Code, 1.2591478F);
        ...
        {
            var fx = new ExchangeRate(_euro.Code, _dollar.Code, 1.2591478F, 3);
        ...
        {
            // Arrange, Act
            Action action = () => new ExchangeRate(_euro.Code, _euro.Code, 1.2591F);
        ...
        {
            // Arrange, Act
            Action action = () => new ExchangeRate(_euro.Code, _euro.Code, -1.2F);
        ...
        {
            // Arrange, Act
            Action action = () => new ExchangeRate(default(Currency).Code, _dollar.Code, 1.2591);
        ...
        {
            // Arrange, Act
            Action action = () => new ExchangeRate(_euro.Code, default(Currency).Code, 1.2591);
    ...
    {
        ExchangeRate fx = new(Currency.FromCode("EUR").Code, Currency.FromCode("USD").Code, 1.2524);
    ...
    public class GivenIWantToDeconstructExchangeRate
    {
        ...
        {
            var fx = new ExchangeRate(Currency.FromCode("EUR").Code, Currency.FromCode("USD").Code, 1.2591m);
