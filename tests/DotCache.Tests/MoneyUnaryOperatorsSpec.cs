...
namespace DotCache.Tests
{
    public class GivenIWantToIncrementAndDecrementMoneyUnary
    {
        ...
        public static TheoryData<Money, Currency, decimal> TestData => new()
        {
    ...
    {
        private readonly Money _tenEuroPlus = new(10.00m, "EUR");
        private readonly Money _tenEuroMin = new(-10.00m, "EUR");
