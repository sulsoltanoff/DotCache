...
#pragma warning disable CA1801 // Parameter context of method.ctor is never used.
    /// <summary>Initializes a new instance of the <see cref="ValueObject.Money"/> struct.Initializes a new instace of <see cref="ValueObject.Money"/> with serialized data.</summary>
    /// <param name="info">The <see cref="SerializationInfo"/> that holds the serialized object data about the <see cref="ValueObject.Money"/>.</param>
