...
namespace DotCache.Tests
{
    ...
    {
        private Money _yen = new(765.4321m, Currency.FromCode("JPY"));
        private Money _euro = new(765.4321m, Currency.FromCode("EUR"));
        private Money _dollar = new(765.4321m, Currency.FromCode("USD"));
        private Money _dinar = new(765.4321m, Currency.FromCode("BHD"));
